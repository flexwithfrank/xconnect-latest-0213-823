  ...
  const handleImagePick = async () => {
    try {
      ...
      if (result) {
        ...
        const publicUrl = await uploadProfileImage(result.uri, user.id);
        if (!publicUrl) {
            ...
            >
              <View style={styles.avatarContainer}>
                <View style={styles.avatarWrapper}>
                  <Image
                    source={{ 
                      uri: form.avatar_url || 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=200&h=200&fit=crop'
                    }}
                    style={styles.avatar}
                  />
                  <TouchableOpacity 
              ...
              <View style={styles.form}>
                ...
                <Input
                  ...
                  onChangeText={(text) => setForm({ ...form, favorite_workout: text })}
