import { View, Text, StyleSheet, FlatList, RefreshControl, Image, TouchableOpacity, Alert, Share } from 'react-native';
    ...
    return (
      ...
      >
        <View style={styles.postHeader}>
          ...
          <View style={styles.postHeaderText}>
            <View style={styles.nameContainer}>
              ...
              <Text style={styles.timeAgo}>1h</Text>
              {isCurrentUserPost && (
                <TouchableOpacity 
                  style={styles.moreButton}
                  onPress={() => handleDeletePost(item.id)}
                >
                  <MaterialCommunityIcons name="delete-outline" size={16} color="#ff4444" />
                </TouchableOpacity>
              )}
            </View>
        ...
        <View style={styles.postActions}>
          ...
          >
            <MaterialCommunityIcons name="reply-outline" size={18} color="#666666" />
          </TouchableOpacity>
          ...
          >
            <MaterialCommunityIcons name="share-variant-outline" size={18} color="#666666" />
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
    );
